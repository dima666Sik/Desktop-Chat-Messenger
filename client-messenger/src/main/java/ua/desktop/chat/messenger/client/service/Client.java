...
public class Client implements Runnable {
    ...
    public void tryConnect() {
        try {
            ...
            logger.error("Cannot Connect, maybe you forget to start Server before work with Clients...", e);
            throw new ConnectionException("Cannot Connect, maybe you forget to start Server before work with Clients...", e);
