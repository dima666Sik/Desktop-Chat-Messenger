...
public class ChatHandler {
    ...
    public void validateChatExistence(ChatDTO chatDTO) throws OpenSessionException {
    ...
    public List<ChatDTO> getChatList(ChatDTO chatDTO) throws OpenSessionException {
