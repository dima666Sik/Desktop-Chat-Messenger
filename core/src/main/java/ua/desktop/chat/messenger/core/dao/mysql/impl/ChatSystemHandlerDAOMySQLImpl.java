...
public class ChatSystemHandlerDAOMySQLImpl implements ChatSystemHandlerDAO {
    ...
    @Override
    public boolean createChatByUser(String nameChat, TypeChat typeChat, User user, Long idUserCompanion)
    ...
    public Optional<Chat> readChatCompanion(Chat chat) throws OpenSessionException {
        try (Session session = DBConnector.getSession()) {
            ...
            query.setParameter("userCompanionId", chat.getUser()
                                                      .getId());
    ...
    public Optional<Chat> findChatByChatNameAndUserId(String nameChat, Long userId) throws OpenSessionException {
        try (Session session = DBConnector.getSession()) {
            session.beginTransaction();
