...
public class ChatExitHandler {
    ...
    void processExitCommand() throws IOException, OpenSessionException {
    ...
    public void exitUser() throws OpenSessionException {
        try {
    ...
    public synchronized void removeClient(String username, ChatDTO chatDTO) throws OpenSessionException {
