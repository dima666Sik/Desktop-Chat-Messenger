...
public class ConnectionHandler implements Runnable {
    ...
    private Map<String, ua.desktop.chat.messenger.server.domain.ifaces.Observer> clientHandlers = new HashMap<>();
    ...
    public void sendMessage(ua.desktop.chat.messenger.server.domain.ifaces.Observer sender, String clientRCVR, String userJSON, String msgJSON) {
        ...
        if (message.getChat().getTypeChat() == TypeChat.GLOBAL || message.getChat().getTypeChat() == TypeChat.GROUP) {
            ...
            for (String key : clientHandlers.keySet()) {
                ua.desktop.chat.messenger.server.domain.ifaces.Observer client = clientHandlers.get(key);
    ...
    public synchronized void addClient(String username, ua.desktop.chat.messenger.server.domain.ifaces.Observer ch) {
    ...
    public synchronized Map<String, ua.desktop.chat.messenger.server.domain.ifaces.Observer> getClientHandlers() {
